            ...
            <div class="row pt-3 pb-2 menu-search">
                <div class="col mobile-shadow">
                    <div class="d-flex gap-lg-3">
                        <button type="button" class="btn btn-catalog" data-bs-toggle="dropdown"
                                data-bs-target="#mainMenu" aria-expanded="false" data-bs-auto-close="false">
                            <svg class="me-lg-3 open-button" width="16" height="18" viewBox="0 0 16 18" fill="none"
                        ...
                        <search-form class="w-100 d-block">
                            <form action="{{ route('shop.search') }}" class="search-form" method="get" id="searchForm">
                                @csrf
                                <input class="form-control" type="text" name="query" id="search" aria-label="search"
                                       placeholder="Поиск" value="{{ request()->get('query') }}">
                                <svg class="search-icon" width="25" height="29" viewBox="0 0 25 29" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="11.9822" cy="12.5681" r="9" transform="rotate(-105 11.9822 12.5681)"
                                            stroke="#a0a0a0"/>
                    ...
                    @if(Route::current()->getName() !== 'home')
                        <a href="{{ route('home') }}" class="logo-link">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <svg class="logo-icon" viewBox="0 0 46 45" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path class="colorized"
                                          d="M44.2839 16.1036C47.834 28.0139 41.009 40.5328 29.0396 44.0655C17.0703 47.5981 4.4893 40.8067 0.939138 28.8964C-2.61102 16.9861 4.21406 4.46716 16.1834 0.934507C28.1527 -2.59814 40.7337 4.19328 44.2839 16.1036Z"
                                          fill="#A8ABB2"/>
                                    <path
                                        d="M42.5773 13.6744C45.24 22.6071 40.1212 31.9964 31.1442 34.6458C22.1672 37.2953 12.7314 32.2018 10.0688 23.269C7.40617 14.3363 12.525 4.94709 21.502 2.2976C30.4789 -0.351884 39.9147 4.74168 42.5773 13.6744Z"
                                        fill="white"/>
                                    <path class="colorized"
                                          d="M39.8832 17.9709C39.4155 24.4245 33.7788 29.279 27.2932 28.8136C20.8076 28.3483 15.9291 22.7393 16.3967 16.2857C16.8644 9.83205 22.5011 4.97759 28.9867 5.44295C35.4724 5.9083 40.3509 11.5172 39.8832 17.9709Z"
                                          fill="#A8ABB2"/>
                                    <path
                                        d="M35.956 20.0384C35.5819 25.2013 31.0725 29.0848 25.884 28.7126C20.6955 28.3403 16.7927 23.8531 17.1668 18.6902C17.5409 13.5273 22.0503 9.64373 27.2388 10.016C32.4273 10.3883 36.3301 14.8755 35.956 20.0384Z"
                                        fill="white"/>
                                    <path
                                        d="M35.956 20.0384C35.5819 25.2013 31.0725 29.0848 25.884 28.7126C20.6955 28.3403 16.7927 23.8531 17.1668 18.6902C17.5409 13.5273 22.0503 9.64373 27.2388 10.016C32.4273 10.3883 36.3301 14.8755 35.956 20.0384Z"
                                        fill="white"/>
                                    ...
                                    <path
                                        ...
                                        fill="white"/>
                                    <path class="colorized"
                                          d="M30.5043 21.201C30.3248 23.678 28.1613 25.5413 25.672 25.3627C23.1827 25.1841 21.3102 23.0312 21.4897 20.5542C21.6692 18.0772 23.8327 16.2139 26.322 16.3925C28.8113 16.5711 30.6838 18.724 30.5043 21.201Z"
                                          fill="#A8ABB2"/>
                                </svg>
                    ...
                    <div class="d-flex w-100">
                        ...
                        <div class="btn-toolbar control-icons ms-auto">
                            @auth
                                <div class="dropdown">
                                    <button type="button" class="btn btn-link dropdown-toggle" data-bs-toggle="dropdown"
                                            data-bs-target="#clientMenu" aria-expanded="false">
                                        <svg width="23" height="29" viewBox="0 0 25 30" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="12.5003" cy="8.11289" r="6.79032" stroke="#1A5294"
                                                    stroke-width="2"/>
                                            <path
                                                d="M24 30V26.129C24 21.7107 20.4183 18.129 16 18.129H9C4.58172 18.129 1 21.7107 1 26.129V30"
                                                stroke="#1A5294" stroke-width="2"/>
                                        </svg>
                                    </button>
                                    <ul class="dropdown-menu" id="clientMenu">
                                        <li>
                                            <a href="{{ route('cabinet.profile.index') }}" class="dropdown-item">Личный
                                                кабинет</a>
                                        </li>
                                        <li>
                                        ...
                                        @if(auth()->user()->userProfile->isAdmin())
                                            <li>
                                                <a href="{{ route('admin.home') }}" target="_blank"
                                                   class="dropdown-item">Панель администратора</a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                                <a href="{{ route('cabinet.profile.index').'#wishlist-tab-pane' }}" class="btn btn-link d-none d-lg-flex align-items-baseline" id="wishlistLink">
                            ...
                            <a href="#" id="cartLink" class="btn btn-link">
                                <x-count-cart/>
                                <svg width="32" height="29" viewBox="0 0 33 30" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6.92578 6.194H31.5974L28.1347 18.3134H14.7168" stroke="#1A5294"
                                          stroke-width="2"/>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 d-flex flex-column justify-content-between">
                <div class="copyright">
                    <p>© {{ Carbon\Carbon::now()->year }} «Обои Центр» Права защищены.<br>Копирование информации
                        запрещено.</p>
                </div>
            ...
            <div class="col-lg-4" id="subscribeNews">
                <p class="subscribe">Подписаться на рассылку</p>
                <form action="{{ route('subscribe') }}" method="POST" novalidate>
                    @csrf
                    <div class="input-group">
                        <div class="form-floating">
                            <input class="form-control @error('subscriber') is-invalid @enderror" id="subscribe" type="email" name="subscriber" placeholder="E-mail">
                        ...
                        @error('subscriber')<span class="invalid-feedback d-block">{{ $message }}</span>@enderror
                    </div>
                </form>
            </div>
        </div>
...
<noscript><div><img src="https://mc.yandex.ru/watch/94730577" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>
